  ...
  <div class="max-w-4xl mx-auto p-8 font-roboto">
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
      <button
        ...
        class="aspect-square rounded-xl bg-gradient-to-br from-purple-500 to-purple-700 text-white p-4 hover:from-purple-600 hover:to-purple-800 transition-colors shadow-md hover:shadow-lg flex flex-col items-center justify-center transform hover:-translate-y-1 duration-200"
      >
