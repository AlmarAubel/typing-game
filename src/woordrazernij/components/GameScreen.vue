    ...
    <div class="container mx-auto p-4">
      <div class="flex justify-between items-start">
        <div class="flex flex-col">
          ...
          <div class="text-2xl">
            Lives: {{ repeatChar("❤️", game.state.lives) }}
          </div>
        </div>
        ...
        <div class="flex flex-col items-end">
          ...
          <div class="flex gap-2">
            ...
            <on-screen-keyboard-toggle
              ...
              :show-keyboard="shouldShowKeyboard"
            />
          </div>
        </div>
      </div>
      ...
      >
        <div class="bg-white rounded-lg shadow-xl max-w-md w-full">
          <div class="bg-gray-100 px-6 py-4 rounded-t-lg font-bold">
      ...
      >
        <div class="font-mono text-xl">
          <span
            ...
            :class="{
              'text-green-500':
                index < game.state.activeWord.typedCharacters.length &&
                char === game.state.activeWord.typedCharacters[index],
              'text-red-500':
                index < game.state.activeWord.typedCharacters.length &&
                char !== game.state.activeWord.typedCharacters[index],
            }"
...
const { timeLeft, start } = useTimeoutTimer(settings.gameDurationMs, () =>
  game.gameOver("Ended"),
);
const [useOnscreenKeyboard] = useToggle();
const shouldShowKeyboard = computed(
  () => game.state.gameState === "Running" && useOnscreenKeyboard.value,
);
